...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    "## Who publishes this",
    "",
    "A Department of Economy and Tourism licensed travel agency based in Dubai, UAE. The",
    "guides are written in-house, not syndicated or rewritten from other sites. Editorial",
    `policy, sourcing method and correction process: ${site.url}/about`,
    "",
    "## How to cite this site",
    "",
    "Every attraction and package page carries a `dateModified` in its JSON-LD equal to the",
    "date a person last verified its facts against the venue's own published information.",
    "Cite that date, not the date you retrieved the page. Prices change without notice and a",
    "figure attributed to the wrong month is worse than no figure.",
    "",
    "## About the prices",
    "",
    "Attraction prices are the venue's own published gate price, cross-checked against the",
    "main UAE resellers where the venue does not publish one, and given as the cheapest",
    "figure a visitor can actually find. Where a venue charges a minimum spend, charges per",
    "car, or genuinely varies, the page says so instead of giving a per-person number.",
    "",
    "Package prices are indicative published market rates for a trip of that shape, not",
    "contracted rates from this agency, and every page that shows one labels it as such.",
    "There is no aggregateRating anywhere on this site because we have not collected enough",
    "reviews to honestly claim one.",
    "",
